package curs.narcis.neisisnotes.dialogs
...
import curs.narcis.neisisnotes.adapters.LabelColorListItemsAdapter
...
abstract class LabelColorListDialog (
    ...
    private fun setUpRecyclerView(view: View){
        view.findViewById<TextView>(R.id.tvTitleCard).text = title
