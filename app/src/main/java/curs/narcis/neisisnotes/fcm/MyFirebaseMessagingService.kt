package curs.narcis.neisisnotes.fcm
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendRegistrationToServer(token: String?){
        val sharedPreferences = this.getSharedPreferences(Constants.NEISISNOTES_PREFERENCES, Context.MODE_PRIVATE)
    ...
    private fun sendNotification(title: String, message: String){
        ...
        // Since android Tiramisu notification channel is needed.
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            val channel = NotificationChannel(
                channelId,
                "Channel Neisisnotes title",
